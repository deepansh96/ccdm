...
- `Python 3` - small embedded process inspection and JSON update helpers in shell scripts.
...
- No database; update structured JSON with JSON parsers, not text substitution.
