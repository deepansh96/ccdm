...
| Usage stats poster | Secret-free LaunchAgent rendering | Covered | Installer scenarios validate the Pillow prerequisite, hand-author absolute Python, Codex, poster, and log paths plus the 600-second default, and assert no credentials, channel IDs, or config values are rendered. |
